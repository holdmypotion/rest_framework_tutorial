...
#         # data is a pyton native dict/object
#         serializer = SnippetSerializer(snippet, data=data)
#         # serializer is OrderedDict 
...
class SnippetViewSet(viewsets.ModelViewSet):
    ...
    #     template_name = 'quickstart/home.html'
    #     queryset = self.queryset
    #     return Response(
    #         {'snippets': queryset}, template_name = 'quickstart/home.html'
    #     )

    # def retrieve(self, request, pk):
    #     template_name = 'quickstart/detail.html'
    #     snippet = self.get_object()
    #     return Response(
    #         {'snippet': snippet}, template_name = 'quickstart/detail.html'
    #     )
